...
GAMES = [
    ...
    ("Tree Decorate", 'voodoo'),
    ("Art Of Clay", 'voodoo'),
    ("Save Them All", 'voodoo'),
    ("Soap Master 3D", 'voodoo'),
    ("Flippy Fork", 'voodoo'),
    ("Candy Master", 'voodoo'),
    ("Tower Stack", 'voodoo'),
    ("Tower Wiper", 'voodoo'),
    ...
    ("Hangsome", 'voodoo'),
    ("Jewelry Store 3D", 'supersonic'),
    ("Pet Salon 3D", 'voodoo'),
    ("Delivery Run 3D", 'boomhit'),
    ("Bucket Race", 'voodoo'),
    ("Fire It Up", 'voodoo'),
    ("DIY iPear", 'voodoo'),
    ("Candy Merge", 'voodoo'),
